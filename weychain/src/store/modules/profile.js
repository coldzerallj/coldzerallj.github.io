...
import { STORE_TYPE, STORAGE_CURRENT_USER_INFO, LOGIN_COOKIE_KEY, ROUTE_NAME } from '@HELPER/const';
const storage = localStorage;
const { RN_HOME } = ROUTE_NAME;
const { LOGIN, LOGOUT, SET_USERID, SET_USERNAME, SET_EMAIL, SET_ROLE_TYPE, GET_PERMISSIONS, SET_PERMISSIONS_ROUTER, SET_PERMISSIONS_FULL } = STORE_TYPE;
	...
	[GET_PERMISSIONS]: async ({ commit }) => {
		...
		const fakePermissions = [
			...
			},
			{
				...
				childs: ['content_management', 'boutique_list', 'boutique_add'],
			},
