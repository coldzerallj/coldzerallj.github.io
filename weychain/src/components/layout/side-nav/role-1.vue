<template>
	<div>
		<div v-if="needNavGroup($ALL_CONST.NAV_GROUP.TASK_MANAGEMENT)">
			...
			<router-link :to="$ALL_CONST.ROUTE_NAME.RN_ROLE1_TM_LIST" v-if="needRouteEntrance($ALL_CONST.ROUTE_NAME.RN_ROLE1_TM_LIST)">
				list
			</router-link>
			<br />
			<router-link :to="$ALL_CONST.ROUTE_NAME.RN_ROLE1_TM_REPORT" v-if="needRouteEntrance($ALL_CONST.ROUTE_NAME.RN_ROLE1_TM_REPORT)">
				report
			</router-link>
		</div>
		<div v-if="needNavGroup($ALL_CONST.NAV_GROUP.ROLES_MANAGEMENT)">
			...
			<router-link :to="$ALL_CONST.ROUTE_NAME.RN_ROLE1_RM_LIST" v-if="needRouteEntrance($ALL_CONST.ROUTE_NAME.RN_ROLE1_RM_LIST)">
				list
			</router-link>
			<br />
			<router-link :to="$ALL_CONST.ROUTE_NAME.RN_ROLE1_RM_REPORT" v-if="needRouteEntrance($ALL_CONST.ROUTE_NAME.RN_ROLE1_RM_REPORT)">
				report
			</router-link>
		</div>
		<br />
